...
@section('content')
									...
									<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
										...
										<div class="col-xl-8">
											...
											<div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color:#020202;background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-62.jpg')">
												<!--begin::Body-->
										...
										<div class="col-xl-4">
											...
											<div class="card card-flush h-xl-100" id="kt_player_widget_2">
												...
												<div class="card-body bg-black pt-0">
													<!--begin::Image-->
													<div class="mx-auto mb-6 bgi-no-repeat bgi-size-contain bgi-position-center rounded-circle w-125px h-125px" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-59.jpg')"></div>
													<!--end::Image-->
													<!--begin::Section-->
													...
													<div class="row g-5 g-xl-9 mb-5 mb-xl-9">
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-61.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-60.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-63.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-56.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
													...
													<div class="row g-5 g-xl-9 mb-xl-3">
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-57.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-58.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
														...
														<div class="col-sm-3 mb-3 mb-sm-0">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-55.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
														...
														<div class="col-sm-3">
															...
															<div class="m-0">
																...
																<div class="card-rounded position-relative mb-5">
																	<!--begin::Img-->
																	<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded" style="background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/600x600/img-64.jpg')"></div>
																	<!--end::Img-->
																	<!--begin::Play-->
																	<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0" data-kt-element="list-play-button">
																		<i class="bi bi-play-fill text-white fs-2x" data-kt-element="list-play-icon"></i>
												...
												<div class="card-body pt-6">
													...
													<div class="d-flex flex-stack">
														...
														<div class="symbol symbol-circle symbol-60px me-4">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-28.jpg" class="" alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
													...
													<div class="d-flex flex-stack">
														<!--begin::Symbol-->
														<div class="symbol symbol-circle symbol-60px me-4">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-29.jpg" class="" alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
													...
													<div class="d-flex flex-stack">
														<!--begin::Symbol-->
														<div class="symbol symbol-circle symbol-60px me-4">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-9.jpg" class="" alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
													...
													<div class="d-flex flex-stack">
														<!--begin::Symbol-->
														<div class="symbol symbol-circle symbol-60px me-4">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-3.jpg" class="" alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
													...
													<div class="d-flex flex-stack">
														<!--begin::Symbol-->
														<div class="symbol symbol-circle symbol-60px me-4">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-27.jpg" class="" alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
													...
													<div class="d-flex flex-stack">
														<!--begin::Symbol-->
														<div class="symbol symbol-circle symbol-60px me-4">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-30.jpg" class="" alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Section-->
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
													...
													<div class="row align-items-end h-100 gx-5 gx-xl-10">
														...
														<div class="col-md-4 mb-11 mb-md-0">
															...
															<a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/900x600/42.jpg">
																<!--begin::Image-->
																<div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3" style="height: 266px;background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/900x600/42.jpg"></div>
																<!--end::Image-->
																<!--begin::Action-->
														...
														<div class="col-md-4 mb-11 mb-md-0">
															...
															<a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/900x600/40.jpg">
																<!--begin::Image-->
																<div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3" style="height: 266px;background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/900x600/40.jpg"></div>
																<!--end::Image-->
																<!--begin::Action-->
																<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
																	<i class="ki-duotone ki-eye fs-3x text-white">
														...
														<div class="col-md-4">
															...
															<a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/900x600/41.jpg">
																<!--begin::Image-->
																<div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3" style="height: 266px;background-image:url('https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/stock/900x600/41.jpg"></div>
																<!--end::Image-->
																<!--begin::Action-->
																<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
																	<i class="ki-duotone ki-eye fs-3x text-white">
												...
												<div class="card-body d-flex flex-column flex-center">
													...
													<div class="mb-2">
														...
														<div class="py-10 text-center">
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/svg/illustrations/easy/2.svg" class="theme-light-show h-125px" alt="" />
															<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show h-125px" alt="" />
														</div>
														<!--end::Illustration-->
													</div>
													<!--end::Heading-->
															...
															<tbody>
																	...
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-circle symbol-40px me-3">
																				<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-1.jpg" class="" alt="" />
																			</div>
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-circle symbol-40px me-3">
																				<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-2.jpg" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-circle symbol-40px me-3">
																				<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-12.jpg" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-circle symbol-40px me-3">
																				<img src="https://d1v9e8mkwkmsub.cloudfront.net/assets-app-channel/assets/media/avatars/300-11.jpg" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
