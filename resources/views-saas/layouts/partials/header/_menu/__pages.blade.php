...
@include('app::layouts.partials.header._menu.__pages-general')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
...
@include('app::layouts.partials.header._menu.__pages-account')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
...
@include('app::layouts.partials.header._menu.__pages-authentication')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
...
@include('app::layouts.partials.header._menu.__pages-utilities')
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
...
@include('app::layouts.partials.header._menu.__pages-widgets')
        </div>
        <!--end:Tab pane-->
    </div>
    <!--end:Tab content-->
