...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link rel="shortcut icon" href="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/logos/favicon.ico" />
		<!--begin::Fonts(mandatory for all pages)-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Vendor Stylesheets(used for this page only)-->
		<link href="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		<link href="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
		<link href="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/css/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	data-kt-app-sidebar-push-footer="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
					...
					<div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
							...
							<a href="../../demo38/dist/index.html" class="app-sidebar-logo">
								<img alt="Logo" src="https://d23zqfvqndw8ja.cloudfront.net/brandFlowr.png" class="h-25px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
								<img alt="Logo" src="https://d23zqfvqndw8ja.cloudfront.net/brandFlowr.png" class="h-20px h-lg-25px theme-dark-show" />
							</a>
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<!--begin::Sidebar-->
                    @include('layouts.partials.header._sidebar')
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-14.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-2.jpg" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-20.jpg" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-1.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-23.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/svg/files/pdf.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo38/dist/apps/projects/project.html" class="w-30px me-3" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/svg/files/doc.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo38/dist/apps/projects/project.html" class="w-30px me-3" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/svg/files/css.svg" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-29.jpg" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-31.jpg" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-40.jpg" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-4.jpg" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
							...
							<div class="d-flex flex-column align-items-start">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-25.jpg" />
									</div>
									<!--end::Avatar-->
									<!--begin::Details-->
									<div class="ms-3">
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<!--begin::Avatar-->
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-1.jpg" />
									</div>
									<!--end::Avatar-->
								</div>
								<!--end::User-->
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-1.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-3.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-8.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-26.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-21.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-34.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/stock/600x400/img-27.jpg" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
											...
											<div class="row gy-10">
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo1/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo1.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo2/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo2.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo30/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo30.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo39/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo39.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo31/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo31.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo27/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo27.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo6/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo6.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo3/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo3.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo23/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo23.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo38/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo38.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo36/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo36.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo10/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo10.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo35/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo35.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo8/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo8.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo25/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo25.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo20/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo20.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo7/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo7.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo43/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo43.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo32/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo32.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo42/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo42.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo44/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo44.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo33/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo33.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo37/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo37.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo11/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo11.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo16/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo16.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo26/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo26.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo22/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo22.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo19/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo19.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo40/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo40.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo29/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo29.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo24/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo24.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo4/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo4.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo41/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo41.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo18/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo18.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo21/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo21.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo34/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo34.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo15/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo15.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo14/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo14.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo9/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo9.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo5/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo5.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo13/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo13.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo12/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo12.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo48/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo48.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo28/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo28.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo17/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo17.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="https://preview.keenthemes.com/metronic8/demo49/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/demos/demo49.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
											...
											<div class="row gy-10">
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/marketing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/marketing.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/social.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/social.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/ecommerce.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/ecommerce.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/store-analytics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/store-analytics.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/logistics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/logistics.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/delivery.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/delivery.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/online-courses.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/online-courses.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/school.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/school.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/crypto.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/crypto.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/finance-performance.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/finance-performance.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/website-analytics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/website-analytics.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/bidding.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/bidding.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/podcast.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/podcast.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/projects.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/projects.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/call-center.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/call-center.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-md-4">
													...
													<a href="../../demo38/dist/dashboards/pos.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/dashboards/pos.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
											...
											<div class="row gy-10">
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/projects/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/projects.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/ecommerce/catalog/products/products.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/ecommerce.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/customers/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/customers.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/subscriptions/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/subscriptions.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/user-management/users/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/user-management.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/invoices/create/main.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/invoices.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/support-center/overview/main.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/support-center.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/chat/private.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/chat.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/calendar/calendar.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/calendar.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/file-manager/list/folders.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/file-manager.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/inbox/listing/listing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/inbox.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
												...
												<div class="col-lg-4">
													...
													<a href="../../demo38/dist/apps/contacts/getting-started.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
														...
														<!--begin::Thumbnail-->
														<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
															<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/apps/contacts.png" class="lozad w-100 rounded" />
														</span>
														<!--end::Thumbnail-->
													</a>
													<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/layouts/corporate/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-corporate.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/layouts/creative/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-creative.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/layouts/fancy/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-fancy.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/layouts/overlay/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-overlay.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/extended/multi-steps-sign-up.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-multistep.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/extended/two-factor-auth.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-2factor.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/password-confirmation.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-passwordchanged.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/verify-email.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-verifyemail.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/welcome.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-welcome.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/coming-soon.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-comingsoon.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/account-deactivated.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-accountdeactivated.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/error-404.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-404.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/general/error-500.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/auth-500.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
															...
															<div class="row g-10 pt-2 pb-5">
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/user-profile/overview.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/profile-overview.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/user-profile/campaigns.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/profile-campaigns.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/user-profile/documents.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/profile-documents.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/user-profile/followers.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/profile-followers.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/user-profile/activity.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/profile-activity.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
															...
															<div class="row g-10 pt-2 pb-5">
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/about.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/corporate-aboutus.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/contact.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/corporate-contactus.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/licenses.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/corporate-license.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/team.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/corporate-ourteam.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/sitemap.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/corporate-sitemap.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
															...
															<div class="row g-10 pt-2 pb-5">
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/social/feeds.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/social-activity.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/social/activity.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/social-feeds.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/social/followers.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/social-followers.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/social/settings.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/social-settings.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
															...
															<div class="row g-10 pt-2 pb-5">
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/faq/classic.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/faq-classic.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/faq/extended.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/faq-extended.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/blog/home.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/blog-home.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
																...
																<div class="col-lg-4">
																	...
																	<a href="../../demo38/dist/pages/blog/post.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																		...
																		<!--begin::Thumbnail-->
																		<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																			<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/blog-post.png" class="lozad w-100 rounded" />
																		</span>
																		<!--end::Thumbnail-->
																	</a>
																	<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/overview.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-overview.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/settings.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-settings.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/billing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-billing.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/security.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-security.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/referrals.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-referrals.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/logs.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-logs.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/api-keys.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-apikeys.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/account/statements.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/account-statements.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/general/view-users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-viewfriends.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/general/upgrade-plan.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-upgradeplan.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/top-up-wallet.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-topupwallet.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/general/share-earn.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-shareandearn.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/general/select-users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-selectuser.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/forms/bidding.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-placeyourbid.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/offer-a-deal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-offeradeal.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/forms/new-target.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-newtarget.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/forms/new-card.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-newcard.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/forms/new-address.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-newaddress.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/general/invite-friends.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-invitefriend.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/create-project.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-createproject.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/create-campaign.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-createcampaign.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/create-account.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-createbusinessacc.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/create-app.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-createapp.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/forms/create-api-key.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-createapikey.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/modals/wizards/two-factor-authentication.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/modal-2factorauth.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/wizards/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/wizard-2factorauth.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/wizards/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/wizard-horizontal.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/wizards/vertical.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/wizard-vertical.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/search/users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/search-users.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/search/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/search-horizontal.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/search/vertical.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/search-vertical.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/utilities/search/select-location.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/search-location.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/widgets/charts.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/widgets-charts.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/widgets/feeds.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/widgets-feeds.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/widgets/lists.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/widgets-lists.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/widgets/mixed.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/widgets-mixed.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/widgets/statistics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/widgets-stats.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/widgets/tables.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/widgets-tables.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
													...
													<div class="row g-10">
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/welcome-message.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-welcome.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/subscription-confirmed.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-subscriptionconfirmed.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/reset-password.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-resetpassword.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/card-declined.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-creditcarddeclined.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/promo-1.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-promo1.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/promo-2.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-promo2.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
														...
														<div class="col-lg-4">
															...
															<a href="../../demo38/dist/authentication/email/promo-3.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
																...
																<!--begin::Thumbnail-->
																<span class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
																	<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/demos/placeholder.jpg" data-src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/preview/prebuilts/pages/email-promo3.png" class="lozad w-100 rounded" />
																</span>
																<!--end::Thumbnail-->
															</a>
															<!--end::Preview-->
							...
							<div class="mh-375px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-6.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-6">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-5.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-6">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-9.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-6">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-23.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-6">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-12.jpg" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-6">
							...
							<div class="py-5">
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Avatar-->
												<div class="symbol symbol-35px symbol-circle">
													<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-13.jpg" />
												</div>
												<!--end::Avatar-->
												<!--begin::Details-->
												<div class="ms-5">
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Avatar-->
												<div class="symbol symbol-35px symbol-circle">
													<img alt="Pic" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/avatars/300-21.jpg" />
												</div>
												<!--end::Avatar-->
												<!--begin::Details-->
												<div class="ms-5">
								...
								<div data-kt-search-element="empty" class="text-center d-none">
									...
									<div class="text-center px-5">
										<img src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/illustrations/sketchy-1/1.png" alt="" class="w-100 h-200px h-sm-325px" />
									</div>
									<!--end::Illustration-->
								</div>
								<!--end::Empty-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<img alt="Logo" src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Invite Gmail Contacts</div>
		...
		<script>var hostUrl = "https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/"; var toggle;</script>
	
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/plugins/global/plugins.bundle.js"></script>
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/js/scripts.bundle.js"></script>

		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		...
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/plugins/custom/datatables/datatables.bundle.js"></script>
	
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/js/widgets.bundle.js"></script>
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/js/custom/widgets.js"></script>
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/js/custom/apps/chat/chat.js"></script>
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="https://d23zqfvqndw8ja.cloudfront.net/v2024-bundle-m8/js/custom/utilities/modals/users-search.js"></script>
