<div class="app-brand ">
    <a href="{{ route('dashboard')}}" class="app-brand-link">
        ...
        <img src="https://d23zqfvqndw8ja.cloudfront.net/images/greenhouse-logo-sq.png" alt="" style="max-width:33px;" class="img-fluid mx-2">
        </span>
        <span class="app-brand-text  menu-text fw-bold ml-3">GreenHouse</span>
    </a>
